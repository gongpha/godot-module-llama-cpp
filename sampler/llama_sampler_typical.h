...
class LlamaSamplerTypical : public LlamaSampler {
	GDCLASS(LlamaSamplerTypical, LlamaSampler);
...
protected:
	static void _bind_methods() {
		...
		ClassDB::bind_method(D_METHOD("set_min_keep", "min_keep"), &LlamaSamplerTypical::set_min_keep);
	...
	struct llama_sampler* _make_sampler(const llama_vocab *vocab) override { return llama_sampler_init_typical(p, (size_t)min_keep); }
